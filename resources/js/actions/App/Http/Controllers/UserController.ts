...
* @see app/Http/Controllers/UserController.php:136
* @route '/users/{user}'
*/
...
* @see app/Http/Controllers/UserController.php:159
...
* @see app/Http/Controllers/UserController.php:174
* @route '/users/{user}'
*/
...
/**
* @see \App\Http\Controllers\UserController::impersonate
* @see app/Http/Controllers/UserController.php:244
* @route '/users/{user}/impersonate'
*/
...
/**
* @see \App\Http\Controllers\UserController::leaveImpersonate
* @see app/Http/Controllers/UserController.php:269
* @route '/leave-impersonate'
*/
export const leaveImpersonate = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: leaveImpersonate.url(options),
    method: 'post',
})

leaveImpersonate.definition = {
    methods: ["post"],
    url: '/leave-impersonate',
} satisfies RouteDefinition<["post"]>
...
* @route '/leave-impersonate'
*/
leaveImpersonate.url = (options?: RouteQueryOptions) => {
    return leaveImpersonate.definition.url + queryParams(options)
}
...
* @route '/leave-impersonate'
*/
leaveImpersonate.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: leaveImpersonate.url(options),
    method: 'post',
})
...
* @route '/leave-impersonate'
*/
const leaveImpersonateForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: leaveImpersonate.url(options),
    method: 'post',
})
...
* @route '/leave-impersonate'
*/
leaveImpersonateForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: leaveImpersonate.url(options),
    method: 'post',
})

leaveImpersonate.form = leaveImpersonateForm

const UserController = { index, create, store, show, edit, update, destroy, toggleStatus, impersonate, leaveImpersonate }
