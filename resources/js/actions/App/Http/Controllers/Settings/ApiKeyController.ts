...
/**
* @see \App\Http\Controllers\Settings\ApiKeyController::toggleStatus
* @see app/Http/Controllers/Settings/ApiKeyController.php:117
* @route '/settings/api-keys/{apiKey}/toggle'
*/
export const toggleStatus = (args: { apiKey: number | { id: number } } | [apiKey: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/settings/api-keys/{apiKey}/toggle'
*/
toggleStatus.url = (args: { apiKey: number | { id: number } } | [apiKey: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { apiKey: args }
    }
...
* @route '/settings/api-keys/{apiKey}/toggle'
*/
toggleStatus.post = (args: { apiKey: number | { id: number } } | [apiKey: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: toggleStatus.url(args, options),
    method: 'post',
})
...
* @route '/settings/api-keys/{apiKey}/toggle'
*/
const toggleStatusForm = (args: { apiKey: number | { id: number } } | [apiKey: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/settings/api-keys/{apiKey}/toggle'
*/
toggleStatusForm.post = (args: { apiKey: number | { id: number } } | [apiKey: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: toggleStatus.url(args, options),
    method: 'post',
})
...
const ApiKeyController = { index, store, update, destroy, toggleStatus }
