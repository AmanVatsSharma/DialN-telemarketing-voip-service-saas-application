...
* @see app/Http/Controllers/Api/V1/UserController.php:29
* @route '/api/v1/users'
*/
...
/**
* @see \App\Http\Controllers\Api\V1\UserController::store
* @see app/Http/Controllers/Api/V1/UserController.php:49
* @route '/api/v1/users'
*/
...
/**
* @see \App\Http\Controllers\Api\V1\UserController::show
* @see app/Http/Controllers/Api/V1/UserController.php:87
...
* @see app/Http/Controllers/Api/V1/UserController.php:103
* @route '/api/v1/users/{user}'
*/
...
/**
* @see \App\Http\Controllers\Api\V1\UserController::destroy
* @see app/Http/Controllers/Api/V1/UserController.php:133
* @route '/api/v1/users/{user}'
*/
